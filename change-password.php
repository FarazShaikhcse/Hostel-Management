											...
											<form method="post" class="form-horizontal" name="changepwd" id="change-pwd" onSubmit="return valid();">
												...
												<div class="form-group">
													...
													<div class="col-sm-6 col-sm-offset-4">
														<button class="btn btn-default text-lg" type="submit">Cancel</button>
														<input type="submit" name="changepwd" Value="Change Password" class="btn btn-primary text-lg col-sm-offset-1">
													</div>

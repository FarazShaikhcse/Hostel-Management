...
if(isset($_POST['submit']))
{
	...
	else
	{
		...
		$stmt->execute();
		$query2="insert into room_occupancy (roomno, occupiedseats) values(?,?)";
		$stmt2 = $mysqli->prepare($query2);
		settype($def, "integer"); 
		$stmt2->bind_param('ii',$roomno,$def);
		$stmt2->execute();
									...
									<div class="panel-body">
										...
										<form method="post" class="form-horizontal">
											...
											<div class="col-sm-8 col-sm-offset-2">
												<input class="btn btn-primary text-sm" type="submit" name="submit" value="Create Room ">
											</div>
										</div>

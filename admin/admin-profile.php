	 					...
	 					<form method="post" class="form-horizontal">
	 						...
	 						<div class="form-group">
	 							...
	 							<div class="col-sm-8 col-sm-offset-2">
	 								<button class="btn btn-default text-sm" type="submit">Cancel</button>
	 								<input class="btn btn-primary text-sm" type="submit" name="update" value="Update Profile">
	 							</div>
	 						</div>
	 					...
	 					<form method="post" class="form-horizontal" name="changepwd" id="change-pwd" onSubmit="return valid();">
	 						...
	 						<div class="form-group">
	 							...
	 							<div class="col-sm-6 col-sm-offset-4">
	 								<button class="btn btn-default text-sm" type="submit">Cancel</button>
	 								<input type="submit" name="changepwd" Value="Change Password" class="btn btn-primary text-sm">
	 							</div>
